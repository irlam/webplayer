<?php
$db_url = "localhost";
$db_name = "omxfcmit_irlam"; //database name
$db_username = "omxfcmit_webplayer"; //database account username
$db_password="Subaru5554346"; //database account password
...
$cors = false;
$dns =  "https://x.3ovus.net"; //Iptv provider dns url (for example "http://domain.com:80"). Used for validation if $cors is true and to prevent vulnerabilities in proxy.php
